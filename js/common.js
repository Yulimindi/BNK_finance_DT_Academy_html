...
function first() {
        ...
        var queryParams = '?' + encodeURIComponent('serviceKey') + '='+'ae3f9a88c1f50ff766075283681821c4d7daee670515d650ec74b597d8b211fc'; /*Service Key*/
        ...
        xhr.onload = () => {
            ...
            console.log(result);
            console.log(result.gyeongnamculturallist.body.items.item[1].fileurl1);
